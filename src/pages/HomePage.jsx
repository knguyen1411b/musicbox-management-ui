    ...
    const initialServices = [
        {
            ...
            price: 35000,
            unit: 'Lon',
            img: 'https://product.hstatic.net/1000281508/product/6-lon-bia-heineken-330ml-201904241647511710_50bd7b00db4b40a9958a32df2e8cec08_master.jpg'
        },
        {
            id: 2,
            type: 'drink',
            ...
            price: 32000,
            unit: 'Lon',
            img: 'https://images.unsplash.com/photo-1597290282695-edc43d0e7129?w=400'
        },
        {
            id: 3,
            type: 'drink',
        ...
        },
        {
            id: 5,
            type: 'food',
            name: 'Trái cây dĩa (Lớn)',
            price: 250000,
            unit: 'Dĩa',
            img: 'https://images.unsplash.com/photo-1519996529931-28324d5a630e?w=400'
        },
        {
            id: 6,
            type: 'food',
        ...
        },
        {
            ...
            price: 120000,
            unit: 'Phần',
            img: 'https://cdn.tgdd.vn/2021/01/CookProduct/comchienhaisan-1200x676.jpg'
        },
        {
            id: 9,
            type: 'food',
            name: 'Gà rán KFC (Phần)',
            price: 95000,
            unit: 'Phần',
            img: 'https://content.jdmagicbox.com/v2/comp/mumbai/m1/022pxx22.xx22.200829100417.u5m1/catalogue/kfc-mumbai-fast-food-1gtb5g7j7r.jpg'
        },
        {
            id: 10,
            type: 'drink',
        ...
        },
        {
            ...
            price: 25000,
            unit: 'Bịch',
            img: 'https://cdn2.fptshop.com.vn/unsafe/1920x0/filters:format(webp):quality(75)/2024_5_13_638511979750318955_lac-rang-muoi-duong-1.jpg'
        },
        {
            id: 12,
            type: 'drink',
            ...
            <header className="fixed w-full z-50 bg-[#0f172a]/80 backdrop-blur-xl border-b border-white/5">
                <nav className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center gap-6 text-sm font-medium">
                        <Link to={'pages/gioithieuhethong'} className="text-gray-300 hover:text-white transition">
                            Giới thiệu hệ thống
                        </Link>
                        <a href="#bang-gia" className="text-gray-300 hover:text-white transition">
                            Bảng giá
                        </a>
                        <a href="#quy-dinh" className="text-gray-300 hover:text-white transition">
                            Nội quy
                        </a>
                        <a href="#vi-tri" className="text-gray-300 hover:text-white transition">
                            Vị trí
                        </a>
                        <a href="#dich-vu" className="text-gray-300 hover:text-white transition">
                            Dịch vụ ăn uống
                        </a>
                    </div>
                ...
                <div
                    className={`md:hidden border-t border-white/5 bg-[#0f172a] transition-all duration-300 ease-in-out overflow-hidden ${
            ...
            <section className="relative min-h-screen flex items-center justify-center pt-24">
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                    ...
                    <p className="text-lg md:text-xl text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                        Hệ thống Karaoke giải trí hiện đại nhất tại Huế. Không gian sang trọng, cách âm chuẩn studio và
                        hệ thống đặt phòng trực tuyến 24/7.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 justify-center">
                        ...
                        <a
                            href="#bang-gia"
                            className="px-10 py-5 bg-white/5 backdrop-blur rounded-2xl font-extrabold text-lg border border-white/10 hover:bg-white/10 text-white transition-all"
                        >
                            Xem bảng giá
                        </a>
                    </div>
                        ...
                        <table className="w-full text-left border-separate border-spacing-y-4">
                            ...
                            <tbody className="text-white">
                                <tr className="bg-white/[0.02] border border-white/5 backdrop-blur-[5px] hover:bg-white/5 transition-colors">
                                    <td className="px-8 py-6 rounded-l-3xl border-l border-white/10 font-bold">
                                        08:00 - 14:00
                                    </td>
                                    <td className="px-8 py-6 text-xl">
                                        49.000đ<span className="text-xs text-gray-500 block">/giờ</span>
                                    </td>
                                    <td
                                        className="px-8 py-6 text-xl text-[#a78bfa]"
                                        style={{ textShadow: '0 0 10px rgba(167, 139, 250, 0.5)' }}
                                    >
                                        69.000đ<span className="text-xs text-gray-500 block">/giờ</span>
                                    </td>
                                    <td className="px-8 py-6 rounded-r-3xl border-r border-white/10 text-xl font-bold">
                                        89.000đ<span className="text-xs text-gray-500 block">/giờ</span>
                                    </td>
                                </tr>
                                <tr className="bg-white/[0.02] border border-white/5 backdrop-blur-[5px] hover:bg-white/5 transition-colors">
                                    <td className="px-8 py-6 rounded-l-3xl border-l border-white/10 font-bold">
                                    ...
                                    <td className="px-8 py-6 text-xl font-bold">
                                        69.000đ<span className="text-xs text-gray-500 block">/giờ</span>
                                    </td>
                                    <td className="px-8 py-6 text-xl font-bold">
                                        89.000đ<span className="text-xs text-gray-500 block">/giờ</span>
                                    ...
                                    <td className="px-8 py-6 rounded-r-3xl border-r border-white/10 text-xl font-bold">
                                        110.000đ<span className="text-xs text-gray-500 block">/giờ</span>
                                    </td>
                                </tr>
                                <tr className="bg-white/[0.02] border border-white/5 backdrop-blur-[5px] hover:bg-white/5 transition-colors">
                                    <td className="px-8 py-6 rounded-l-3xl border-l border-white/10 font-bold bg-[#7c3aed]/10">
                                        17:00 - 24:00
                                    </td>
                                    <td className="px-8 py-6 text-xl font-bold">
                                        89.000đ<span className="text-xs text-gray-500 block">/giờ</span>
                                    ...
                                    <td className="px-8 py-6 text-xl font-bold">
                                        115.000đ<span className="text-xs text-gray-500 block">/giờ</span>
                                    </td>
                                    <td className="px-8 py-6 rounded-r-3xl border-r border-white/10 text-xl font-bold text-[#a78bfa]">
                                        130.000đ<span className="text-xs text-gray-500 block">/giờ</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div className="flex flex-col md:flex-row gap-16 items-start">
                        <div className="md:w-1/3">
                            ...
                            <p className="text-gray-400 mt-4 leading-relaxed">
                                Để đảm bảo trải nghiệm tốt nhất cho mọi khách hàng, vui lòng tuân thủ các quy định chung
                                của <span className="font-bold text-white">MUSICBOX</span>.
                            </p>
                            <div className="mt-8 p-6 rounded-2xl border border-dashed border-[#8b5cf6]/30 bg-[#8b5cf6]/5">
                                <span className="text-xs text-[#a78bfa] font-bold uppercase block mb-2 text-center underline">
                                    Hotline hỗ trợ 24/7
                                </span>
                                <p className="text-2xl font-black text-white text-center tracking-widest">
                                    034 3132 123
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="md:w-2/3 grid sm:grid-cols-2 gap-6">
                            <div className="bg-white/[0.02] border border-white/5 backdrop-blur-[5px] p-6 rounded-2xl flex gap-4">
                                ...
                                <p className="text-sm text-gray-300">
                                    Không hút thuốc và sử dụng chất kích thích (ma túy, shisha, bia...).
                                </p>
                            </div>
                            <div className="bg-white/[0.02] border border-white/5 backdrop-blur-[5px] p-6 rounded-2xl flex gap-4">
                                <span className="text-2xl font-black text-[#7c3aed]">#2</span>
                                <p className="text-sm text-gray-300">
                                    Không mang thức ăn và đồ uống bên ngoài vào MUSICBOX.
                                </p>
                            </div>
                            <div className="bg-white/[0.02] border border-white/5 backdrop-blur-[5px] p-6 rounded-2xl flex gap-4 border-l-2 border-l-[#8b5cf6]">
                                ...
                                <p className="text-sm text-gray-300">
                                    Tự bảo quản tư trang cá nhân trong quá trình sử dụng phòng.
                                </p>
                            </div>
                            <div className="bg-white/[0.02] border border-white/5 backdrop-blur-[5px] p-6 rounded-2xl flex gap-4">
                                <span className="text-2xl font-black text-[#7c3aed]">#4</span>
                                <p className="text-sm text-gray-300">
                                    Liên hệ nhân viên nếu không hài lòng về âm thanh hoặc microphone.
                                </p>
                            </div>
                            <div className="bg-white/[0.02] border border-white/5 backdrop-blur-[5px] p-6 rounded-2xl flex gap-4">
                                <span className="text-2xl font-black text-[#7c3aed]">#5</span>
                                <p className="text-sm text-gray-300">
                                    Vui lòng bảo quản và nâng niu tài sản (mic, màn hình, sofa...).
                                </p>
                            </div>
                            <div className="bg-white/[0.02] border border-white/5 backdrop-blur-[5px] p-6 rounded-2xl flex gap-4">
                                <span className="text-2xl font-black text-[#7c3aed]">#6</span>
                                <p className="text-sm text-gray-300">
                                    Hãy cùng nhau giữ gìn vệ sinh chung và sử dụng đúng mục đích.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <div className="bg-white/[0.02] border border-[#8b5cf6]/20 backdrop-blur-[5px] w-full max-w-5xl mx-auto p-6 md:p-10 rounded-[2.5rem] shadow-2xl">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex items-center gap-2 mt-8 px-6 py-3 bg-white/5 hover:bg-[#7c3aed]/20 text-gray-300 hover:text-white rounded-xl border border-white/10 transition-all font-bold text-sm uppercase tracking-widest"
                        >
                            ...
                            >
                                ...
                                <div className="p-5">
                                    ...
                                    <div className="flex justify-between items-center mt-4">
                                        <span className="text-[#a78bfa] font-black text-lg">
