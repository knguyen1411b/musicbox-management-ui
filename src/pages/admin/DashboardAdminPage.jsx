        ...
        <div className="p-4 border-t border-white/5 relative">
          ...
          <div 
            ...
            className={`flex items-center justify-between p-3 rounded-2xl border transition-all cursor-pointer ${
              openSettings ? 'bg-white/5 border-white/10' : 'bg-transparent border-transparent hover:bg-white/[0.02]'
            }`}
          >
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-[9px] text-[#a78bfa] font-black uppercase tracking-widest mt-0.5">Admin Role</p>
              </div>
            </div>
            <ChevronDown className={`w-4 h-4 text-slate-400 transition-transform duration-300 ${openSettings ? 'rotate-180' : ''}`} />
          </div>
