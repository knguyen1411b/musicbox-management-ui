            ...
            <main className="max-w-6xl mx-auto">
                ...
                {step === 1 && (
                    <section className="rounded-3xl p-6 mb-8" style={glassCardStyle}>
                        <h2 className="text-2xl font-black mb-6 uppercase tracking-tight text-purple-500">
                            Tìm phòng trống
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                <label className="block text-[10px] uppercase font-bold text-purple-300 mb-2">
                                    Loại phòng
                                </label>
                                <select
                                    name="roomSize"
                ...
                {step === 1 && searched && (
                    <section className="max-w-md mx-auto">
                        {availableRoom ? (
                            <div
                                className="rounded-[2rem] overflow-hidden flex flex-col group border border-purple-500/30 transition-all duration-500"
                            ...
                            >
                                ...
                                <div className="p-6">
                                    <div className="text-center mb-6">
                                        ...
                                        <p className="text-[10px] text-purple-300 italic mt-1">
                                            * Số phòng cụ thể sẽ được cung cấp khi bạn đến quầy
                                        </p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-6">
                                        <div className="bg-white/5 p-3 rounded-xl border border-white/5 text-center">
                                            ...
                                            <p className="text-lg font-black text-purple-500">
                                                {availableRoom.gia.n}K/h
                                            </p>
                                        </div>
                                        <div className="bg-white/5 p-3 rounded-xl border border-white/5 text-center">
                                            <p className="text-[8px] text-purple-300 uppercase font-bold">
                                                Số người tối đa
                                            </p>
                                            <p className="text-lg font-black text-purple-500">
                                                {getMaxPeople(filter.size)}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="text-center p-12 rounded-3xl" style={glassCardStyle}>
                                <p className="text-purple-300 font-bold">
                                    Rất tiếc, loại phòng này hiện đã hết vào khung giờ bạn chọn.
                                </p>
                            </div>
                        )}
                    </section>
                            ...
                            <div className="relative z-10 flex flex-col h-full">
                                ...
                                <div className="space-y-4 mb-8">
                                    <div className="flex justify-between items-end border-b border-white/5 pb-4">
                                        <div>
                                            <p className="text-purple-400/60 uppercase text-[9px] font-black tracking-widest mb-1">
                                                Khách hàng
                                            </p>
                                    ...
                                    <div className="grid grid-cols-2 gap-6 bg-white/[0.03] p-4 rounded-2xl border border-white/5">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <p className="text-white font-bold text-sm">
                                                {filter.timeStart} — {filter.timeEnd}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mt-8 pt-4 border-t border-white/5 flex justify-between items-center opacity-40">
                                    <span className="text-[10px] text-purple-300 uppercase tracking-widest">
                                        MusicBox System Booking
                                    </span>
