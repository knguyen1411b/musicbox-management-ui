        ...
        >
            <div className="w-full max-w-md backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 shadow-2xl shadow-black/40 relative overflow-hidden">
                ...
                <div className="text-center mb-6">
                    <h3 id="join-party-title" className="text-xl font-bold text-white tracking-wide">
                        Tham Gia Phòng Hát
                    </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <div className="relative flex items-center">
                            <input
                                ...
                                className="w-full bg-black/30 border border-white/10 focus:border-[#8b5cf6] focus:ring-1 focus:ring-[#8b5cf6] rounded-xl pl-10 pr-4 py-3 text-sm text-white transition-colors placeholder:text-slate-400"
                            />
                            <User className="absolute left-3.5 w-4 h-4 text-[#c4b5fd]" aria-hidden="true" />
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <Sparkles className="w-4 h-4 group-hover:animate-spin" aria-hidden="true" />
                    </button>
                </form>
            </div>
        </div>
