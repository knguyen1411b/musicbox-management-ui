        ...
        >
            <div className="w-full max-w-sm backdrop-blur-xl bg-white/10 border border-white/10 rounded-2xl p-5 shadow-2xl relative overflow-hidden">
                ...
                <div className="flex flex-col items-center text-center repair-modal animate-fade-in">
                    ...
                    <h3 id="confirm-delete-title" className="text-lg font-bold text-white tracking-wide">
                        Xác nhận xóa bài?
                    </h3>
                    <p className="text-xs text-slate-300 mt-2 px-2 leading-relaxed">
                        Bạn có chắc chắn muốn xóa bài <span className="text-rose-400 font-semibold">"{songTitle}"</span>{' '}
                        ra khỏi hàng chờ không?
                    </p>
                </div>
                ...
                <div className="flex gap-3 mt-6">
                    <button
                        type="button"
                        onClick={onCancel}
                        className="flex-1 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-slate-300 hover:text-white text-xs font-semibold transition-colors active:scale-[0.98]"
                    >
                        Hủy bỏ
                    </button>
                    <button
                        type="button"
                        onClick={onConfirm}
                        className="flex-1 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-700 text-white text-xs font-semibold shadow-lg shadow-rose-600/20 transition-colors active:scale-[0.98]"
                    >
                        Xác nhận xóa
                    </button>
                </div>
